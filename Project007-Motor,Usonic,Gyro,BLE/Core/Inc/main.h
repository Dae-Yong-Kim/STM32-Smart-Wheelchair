...
#define FLecho_EXTI_IRQn EXTI1_IRQn
#define FRecho_Pin GPIO_PIN_2
#define FRecho_GPIO_Port GPIOB
#define FRecho_EXTI_IRQn EXTI2_IRQn
#define IN1_Pin GPIO_PIN_10
#define IN1_GPIO_Port GPIOB
#define BBecho_Pin GPIO_PIN_6
#define BBecho_GPIO_Port GPIOC
#define BBecho_EXTI_IRQn EXTI9_5_IRQn
...
#define FFecho_EXTI_IRQn EXTI9_5_IRQn
